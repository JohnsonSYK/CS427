...
DROP TABLE IF EXISTS obstetricsconditions;
...
DROP TABLE IF EXISTS cdcheadcircumferencestats;
DROP TABLE IF EXISTS cdcbmistats;
DROP TABLE IF EXISTS normaltable;
...
DROP TABLE IF EXISTS exerciseEntry;
...
DROP TABLE IF EXISTS ophthalmologySchedule;
